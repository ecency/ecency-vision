...
export const crossEntryInstance: Entry = {
  ...
  author: 'regenerette',
  permlink:
    'we-need-each-one-of-you-sos-financial-advice-for-hive-newcomers-hive-125125',
  ...
  json_metadata: {
    ...
    original_permlink:
      'we-need-each-one-of-you-sos-financial-advice-for-hive-newcomers',
  },
...
export const searchResponseInstance: SearchResponse = {
  ...
  results: [
    ...
    },
    {
      ...
      title_marked:
        '<mark>Ecency</mark> Vision - No beneficiaries, Drafts, Gallery, Bookmarks',
    ...
    },
    {
      ...
      title_marked:
        '<mark>Ecency</mark> Mobile - Rebrand, better onboarding, communities and more',
