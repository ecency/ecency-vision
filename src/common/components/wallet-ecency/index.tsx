...
export const WalletEcency = (props: Props) => {
  ...
  const [estimatedPointsValueLoading, setEstimatedPointsValueLoading] =
    useState(false);
      ...
      <div className='wallet-ecency'>
          ...
          <div className='wallet-info'>
            ...
            <div className='get-points'>
              <div className='points-types'>
                <div className='points-types-title'>
                ...
                return (
                  <div className='transaction-list-body'>
                    ...
                    {!points.loading && points.transactions.length === 0 && (
                      <p className='text-muted empty-list'>
                        {_t('g.empty-list')}
                      </p>
                    )}
                  </div>
        ...
        {purchase && (
          <Purchase
            {...props}
            activeUser={activeUser!}
            onHide={togglePurchase}
          />
        )}
        {promote && (
          <Promote {...props} activeUser={activeUser!} onHide={togglePromote} />
        )}
        {boost && (
          <Boost {...props} activeUser={activeUser!} onHide={toggleBoost} />
        )}
      </div>
    </>
  );
