...
export class EditHistory extends BaseComponent<Props, State> {
    ...
    render() {
        ...
        if (loading) {
            return <div className="edit-history-dialog-content loading"><LinearProgress/></div>
        }
        ...
        return <div className="edit-history-dialog-content">
            <div className="version-list-sm">
                ...
                <Form.Control as="select" value={selected} onChange={this.versionChanged}>
                    {history.map(i => {
                        return <option value={i.v} key={i.v}> {_t("edit-history.version", {n: i.v})}</option>
                    })}
                </Form.Control>
            </div>
            ...
            <div className="version-detail">
                ...
                <div className="entry-tags">{tagSvg}{' '}<span dangerouslySetInnerHTML={tags}/></div>
...
export default class EditHistoryDialog extends Component<Props> {
    render() {
        ...
        return (
            <Modal animation={false} show={true} centered={true} onHide={onHide} keyboard={false} className="edit-history-dialog" size="lg">
