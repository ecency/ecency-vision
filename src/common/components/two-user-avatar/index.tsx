...
export class TwoUserAvatar extends Component<Props> {
    render() {
        ...
        const imageSrc1 = `${defaults.imageServer}${global?.canUseWebp ? "/webp" : ""}/u/${from}/avatar/${imgSize}`;
        const imageSrc2 = `${defaults.imageServer}${global?.canUseWebp ? "/webp" : ""}/u/${to}/avatar/${imgSize}`;
