...
import { hotListItems, notificationListItems, searchListItems, tagsListItems, walletListItems } from "../deck/mockData";
...
export const decks = [
    ...
    {data: walletListItems, listItemComponent: SearchListItem, header: {title: "wallet", icon: wallet}},
]