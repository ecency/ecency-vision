...
export const notificationsIconSvg = (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    />
    <path
      d="M21 6.5C21 7.88071 19.8807 9 18.5 9C17.1193 9 16 7.88071 16 6.5C16 5.11929 17.1193 4 18.5 4C19.8807 4 21 5.11929 21 6.5Z"
      fill="currentColor"
      fillOpacity="0.15"
      stroke="currentColor"
      strokeWidth="1.5"
...
export const hotIconSvg = (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path
      d="M20.1207 12.73L20.8607 13.46C22.3507 14.95 22.3507 16.42 20.8607 17.91L17.9007 20.87C16.4307 22.34 14.9407 22.34 13.4707 20.87"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    />
    <path
      d="M3.11031 10.5101C1.64031 9.02006 1.64031 7.55006 3.11031 6.06006L6.07031 3.10006C7.54031 1.63006 9.03031 1.63006 10.5003 3.10006L11.2403 3.84006"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    />
    <path
      opacity="0.4"
      d="M11.2508 3.8501L7.55078 7.5501"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
    />
...
export const newIconSvg = (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    />
    <g opacity="0.4">
      <path d="M16.5 6.25H22" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
      <path d="M19.25 9V3.5" stroke="currentColor" strokeWidth="2" strokeLinecap="round" />
    </g>
  </svg>
);

export const mutedIconSvg = (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
...
export const marketOrdersIconSvg = (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M21.5008 5.35C21.5008 6.26 21.0708 7.07 20.4108 7.59C19.9308 7.97 19.3208 8.2 18.6508 8.2C17.0708 8.2 15.8008 6.93 15.8008 5.35C15.8008 4.68 16.0308 4.08 16.4108 3.59H16.4208C16.9308 2.93 17.7408 2.5 18.6508 2.5C20.2308 2.5 21.5008 3.77 21.5008 5.35Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
    ...
    />
    <path
      d="M8.2 18.6498C8.2 19.3198 7.97 19.9198 7.59 20.4098C7.07 21.0798 6.26 21.4998 5.35 21.4998C3.77 21.4998 2.5 20.2298 2.5 18.6498C2.5 17.7398 2.93 16.9298 3.59 16.4198V16.4098C4.07 16.0298 4.68 15.7998 5.35 15.7998C6.93 15.7998 8.2 17.0698 8.2 18.6498Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const stakeOperationsIconSvg = (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      d="M8 12H16"
      stroke="currentColor"
...
export const favouritesIconSvg = (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      opacity="0.4"
...
export const delegationsIconSvg = (
  <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path
      opacity="0.4"
