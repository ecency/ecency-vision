...
export default class PopoverConfirm extends Component<Props> {
    ...
    render() {
        const {titleText, okText, okVariant, cancelText, children, trigger} = this.props;
        const {show} = this.state;
            ...
            >
                ...
                <Popover.Content>
                    <div style={{textAlign: "center"}}>
                        <Button size="sm" variant={okVariant || "primary"} style={{marginRight: "10px"}} onClick={this.confirm}>
        ...
        return (
            <>
                <OverlayTrigger defaultShow={true} trigger={trigger || []} overlay={popover} rootClose>
                    {children}
                </OverlayTrigger>
            </>
        );
