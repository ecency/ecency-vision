        ...
        >
          ...
          <Form.Group controlId='cur-pass'>
            ...
            <Form.Control
              ...
              required={true}
              onInvalid={(e: any) =>
                handleInvalid(e, 'password-update.', 'validation-password')
              }
          ...
          <Form.Group controlId='accept'>
            <Form.Check
              ...
              onInvalid={(e: any) =>
                handleInvalid(e, 'password-update.', 'validation-label')
              }
              onInput={handleOnInput}
            />
          </Form.Group>
...
export default class PasswordUpdateDialog extends BaseComponent<
  DialogProps,
  DialogState
> {
  state: DialogState = {
