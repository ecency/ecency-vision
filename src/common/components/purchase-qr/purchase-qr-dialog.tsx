...
export const PurchaseQrDialog = ({ show, setShow, activeUser, location, type }: Props) => {
  return <Modal
    ...
    <Modal.Header closeButton={true}>
      <Modal.Title>{type === PurchaseTypes.POINTS ? _t('purchase-qr.title-points') : _t('purchase-qr.title')}</Modal.Title>
    </Modal.Header>
    <Modal.Body>
      <PurchaseQrBuilder activeUser={activeUser} location={location} queryType={type || PurchaseTypes.BOOST} />
    </Modal.Body>
  </Modal>
}