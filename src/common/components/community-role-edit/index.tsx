...
export class CommunityRoleEdit extends BaseComponent<Props, State> {
    ...
    render() {
        ...
        return <div className="community-role-edit-dialog-content">
...
export default class CommunityRoleEditDialog extends Component<Props> {
    render() {
        ...
        return (
            <Modal animation={false} show={true} centered={true} onHide={onHide} keyboard={false} className="community-role-edit-dialog" size="lg">
