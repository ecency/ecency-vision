        ...
        >
          <Form.Group controlId='title'>
            ...
            <Form.Control
              ...
              autoFocus={true}
              onInvalid={(e: any) =>
                handleInvalid(e, 'fragments.', 'validation-title')
              }
          ...
          <Form.Group controlId='body'>
            ...
            <Form.Control
              onInvalid={(e: any) =>
                handleInvalid(e, 'fragments.', 'validation-value')
              }
              onInput={handleOnInput}
              as='textarea'
              style={{height: '300px'}}
        ...
        >
          ...
          <Form.Group controlId='body'>
            ...
            <Form.Control
              ...
              maxLength={5000}
              onInvalid={(e: any) =>
                handleInvalid(e, 'fragments.', 'validation-body')
              }
              onInput={handleOnInput}
            />
          </Form.Group>
        ...
        {(() => {
          ...
          return (
            <>
              ...
              {items.length === 0 && (
                <span className='text-muted'>{_t('g.no-matches')}</span>
              )}
