...
const LandingPage = (props: any) => {
  ...
  const BgHeroDark = apiBase(`/assets/illustration_hero.${global.canUseWebp?"webp":"png"}`);
  const BgHeroLight = apiBase(`/assets/illustration_hero_day.${global.canUseWebp?"webp":"png"}`);
  const EarnMoney = apiBase(`/assets/illustration_earn_money.${global.canUseWebp?"webp":"png"}`);
  const WhaleCatchsFish = apiBase(`/assets/illustration_true_ownership.${global.canUseWebp?"webp":"png"}`);
  const Decentralization = apiBase(`/assets/illustration_decentralization.${global.canUseWebp?"webp":"png"}`);
  const MechanicFish = apiBase(`/assets/illustration_open_source.${global.canUseWebp?"webp":"png"}`);
  const FishOne = apiBase(`/assets/fish_1.${global.canUseWebp?"webp":"png"}`);
  const FishTwo = apiBase(`/assets/fish_2.${global.canUseWebp?"webp":"png"}`);
  const FishThree = apiBase(`/assets/fish_3.${global.canUseWebp?"webp":"png"}`);
  const FishFour = apiBase(`/assets/fish_4.${global.canUseWebp?"webp":"png"}`);
  const FishFive = apiBase(`/assets/fish_5.${global.canUseWebp?"webp":"png"}`);
  const JuniorFish = apiBase(`/assets/fish_junior.${global.canUseWebp?"webp":"png"}`);
  const SeniorFish = apiBase(`/assets/fish_senior.${global.canUseWebp?"webp":"png"}`);
  const DownloadAndroid = apiBase(`/assets/icon_android.${global.canUseWebp?"webp":"png"}`);
  const OurHistory = apiBase(`/assets/our_history.${global.canUseWebp?"webp":"png"}`);
  const OurTeam = apiBase(`/assets/our_team.${global.canUseWebp?"webp":"png"}`);
  const OurVision = apiBase(`/assets/our_vision.${global.canUseWebp?"webp":"png"}`);
  const FooterMainFish = apiBase(`/assets/footer_main_fish.${global.canUseWebp?"webp":"png"}`);
