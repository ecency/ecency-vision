...
export class ProposalListItem extends Component<Props, State> {
  ...
  render() {
    ...
    const {dynamicProps, proposal, isReturnProposalId, thresholdProposalIds} =
      this.props;
    ...
    const votesHP =
      (Number(proposal.total_votes) / 1e12) * dynamicProps.hivePerMVests;
    ...
    return loadingSearchResult ? (
      ...
      >
        ...
        {proposal.id !== isReturnProposalId &&
          ...
          _.includes(thresholdProposalIds, proposal.id) && (
