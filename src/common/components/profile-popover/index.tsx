...
export const ProfilePopover = (props: any) => {
  ...
  const author = entry.original_entry
    ...
    const timeout = setTimeout(
      () => {
        ...
        document
          ...
          .classList.add("overflow-sm-hidden");
      },
  ...
  const handleHideProfile = (e: any, doNotSetState?: boolean) => {
    ...
    setTimeout(
      () => {
        ...
        document
          .getElementsByTagName("body")[0]
          .classList.remove("overflow-sm-hidden");
      },
              ...
              modifiers={[
                {
                  ...
                  options: {
                    offset: () => [
                      0,
                      window.matchMedia("(max-width: 576px)").matches ? 0 : -30,
                    ],
                  },
                },
              ]}
              ...
              {({ ref, style, placement, arrowProps }) => (
                ...
                >
                  <ProfilePreview
                    username={author}
                    {...props}
                    onClose={(e, doNotSetState) =>
                      handleHideProfile(e, doNotSetState)
                    }
                  />
                </div>
              )}
