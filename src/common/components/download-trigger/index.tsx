        ...
        return <div className="download-dialog-content">
            ...
            <div className="download-buttons">
                ...
                <a className="download-button btn-desktop" target="_blank"
                   href="https://github.com/ecency/ecency-vision/releases/download/3.0.12/Ecency-Setup-3.0.12.exe" rel="noopener noreferrer">Windows</a>
                }
                {(os !== 'iOS' && os !== 'AndroidOS' && os === 'MacOS') &&
                <a className="download-button btn-desktop" target="_blank"
                   href="https://github.com/ecency/ecency-vision/releases/download/3.0.12/Ecency-3.0.12.dmg" rel="noopener noreferrer">Mac</a>
                }
                {(os !== 'iOS' && os !== 'AndroidOS' && (os === 'UnixOS' || os === 'LinuxOS')) &&
                <a className="download-button btn-desktop" target="_blank"
                   href="https://github.com/ecency/ecency-vision/releases/download/3.0.12/ecency-surfer-3.0.12.tar.gz" rel="noopener noreferrer">Linux</a>
                }
                {(os === 'AndroidOS' || os !== 'iOS') &&
