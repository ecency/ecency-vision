      ...
      {menu && (
        <div className='the-menu'>
          <div className='menu-inner'>
            ...
            {props?.preElem && (
              <div className='pre-elem'>{props?.preElem as JSX.Element}</div>
            )}
            ...
            {props?.postElem && (
              <div className='pre-elem'>{props?.postElem as JSX.Element}</div>
            )}
          </div>
        </div>
      )}
