...
export class List extends BaseComponent<Props, State> {
    ...
    render() {
        ...
        if (loading) {
            return (<div className="open-orders-content">
                <LinearProgress/>
            </div>);
        }
                                    ...
                                    return <tr key={orderid} onClick={(e) => {
                                        ...
                                        <td>
                                            <Tooltip content={x.sell_price.quote}>
                                                <span>{tokenType=="HBD"?formattedNumber(x.sell_price.base, {prefix: "$"}):formattedNumber(x.sell_price.base, {suffix: tokenType})}</span>
                                            </Tooltip>
                                        </td>
                                        <td>
