...
export class TokenDetails extends BaseComponent<Props, State> {
  state: State = {
    delegatedList: false,
    receivedList: false,
    convertList: false,
      ...
      <div className="wallet-hive">
        <div className="wallet-main">
          <div className="wallet-info">
            ...
            {params === "hive" && <div className="balance-row hive">
            ...
            {params === "hive-power" && <div className="balance-row hive-power alternative">
              <div className="balance-info">
            ...
            {params === "hbd" && <div className="balance-row hive-dollars">
              <div className="balance-info">
            ...
            {params === "hive" && <div className="balance-row savings alternative">
              <div className="balance-info">
            ...
            {params === "hbd" && <div className="balance-row savings alternative">
              <div className="balance-info">
                <div className="title">{_t("wallet.savings")}</div>
                <div className="description">{_t("wallet.savings-description")}</div>
                <div className="description font-weight-bold mt-2">
            ...
            {params === "hive" && <div className="balance-row estimated alternative">
              <div className="balance-info">
