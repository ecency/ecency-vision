      ...
      <div className="app-content static-page contribute-page">
        <div className="static-content">
          ...
          <p>
            ...
            <a href="https://esteem.app/signup">signup to get your own account</a> and start earning
            cryptocurrency. If you do not mind for rewards, you can get publicity for free, just
            fill out form below and we will make sure to handle rest.
          </p>
          <ul>
            <li>
          ...
          <p>
            ...
            of your post inside form. It is acceptable to publish existing content that you have the
            right to republish. Please review the format instructions above before submitting.
          </p>
          <h2 id="faq">FAQ</h2>
          <ol>
            <li>
              <em>Can I re-publish my contribution to Esteem on another site?</em> Yes. All that we
              request is that you link back to the Esteem article.
            </li>
            <li>
              <em>Can I re-use a previously published article?</em> Yes, if we believe your article
              is relevant to a general audience.
            </li>
          </ol>
        </div>
      </div>
